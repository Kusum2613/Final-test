  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      const createdTicket = await axios.post(
        "https://backend-kvr8.onrender.com/api/tickets",
        {
          visitorId: id,
          initialMessage: mssg,
        }
  ...
  const handleSubmitForm = async () => {
    ...
    try {
      const response = await axios.post(
        "https://backend-kvr8.onrender.com/api/visitors",
        data
      );
  ...
  return (
    <div className="container">
          ...
          <div className="left">
            ...
            <div className="btns">
              <button className="first">
                Get Started
                <img src="./../src/assets/arrowIcon.png" alt="arrow" />
              </button>
              <button className="second">
                <img src="./../src/assets/videoIcon.png" alt="videoIcon" />
                Watch Video
              </button>
            </div>
          </div>
      ...
      <div className="companyLogos">
        <img src="./../src/assets/company_logo.png" alt="logos" />
      </div>
